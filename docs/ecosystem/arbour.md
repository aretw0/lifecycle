...
- **Version Propagation**: With `lifecycle` v1.5+ now available, when Trellis upgrades, Arbour will automatically gain "Suspend/Resume" capabilities for its WhatsApp connections without a single line of code change in Arbour itself.
